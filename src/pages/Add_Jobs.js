...
const Add_Jobs = () => {
    ...
    const PostJob = (e) => {
        ...
        if (Object.keys(errors).length === 0 && Object.keys(err).length === 0) {
            axios.post(`https://works.demo-customproject.com:4001/post-job`, { ...post_data }, { headers: { 'Auth': localStorage.getItem('accessToken') } }).then((res) => {
                                ...
                                <div className="row">
                                    <div className="col-xl-4">
                                        <div className="submit-field">
                                            <h5>Job Title</h5>
                                            <input type="text" name='title' onChange={setVal} className="form-control" />
                                    ...
                                    <div className="col-xl-4">
                                        <div className="submit-field">
                                            ...
                                            <select name='type' onClick={setVal} className="selectpicker form-control" data-size={7} title="Select Job Type">
                                                <option hidden disabled selected>Select Job Type</option>
                                        ...
                                        <div className="submit-field">
                                            ...
                                            <div className="input-with-icon">
                                                <div id="autocomplete-container">
                                                    <input id="autocomplete-input" name='location' onChange={setVal} className="form-control" type="text" placeholder="Type Address" />
                                                </div>
                                        ...
                                        <div className="submit-field">
                                            ...
                                            <div className="row">
                                                <div className="col-xl-6">
                                                    <div className="input-with-icon">
                                                        <input className="form-control" onChange={setVal} name='salary_min' type="number" placeholder="Min" />
                                                ...
                                                <div className="col-xl-6">
                                                    <div className="input-with-icon">
                                                        <input className="form-control" onChange={setVal} name='salary_max' type="number" placeholder="Max" />
                                                        <i className="currency">USD</i>
                                                    </div>
                                    ...
                                    <div className="col-xl-12">
                                        <div className='submit-field'>
                                            ...
                                            <input className='form-control' type='text' onChange={setVal} name='redirect_url' />
                                        </div>
                                    </div>
                                    <div className="col-xl-12">
                                        <div className="submit-field">
                                            <h5>Short Description</h5>
                                            <textarea cols={30} rows={2} onChange={setVal} name='short_discription' className="form-control" defaultValue={""} />
                                    ...
                                    <div className="col-xl-12">
                                        <div className="submit-field">
                                            ...
                                            <Editor value={''} onTextChange={(e) => setEditor(e.htmlValue)} name='discription' style={{ height: '320px' }} />
